...
export const isRemovedStaff = (staffName) => REMOVED_STAFF_NAMES.includes(normalizeStaffName(staffName));

export const normalizeStaffAssignments = (assignments = []) =>
  [...assignments]
    .filter((item) => !isRemovedStaff(item.staffName))
    .sort((a, b) => {
